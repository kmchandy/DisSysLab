# DSL Teaching Plan: Using Claude AI to Teach Distributed Systems

## Mission Statement

**Use Claude AI with DSL to provide self-paced learning of distributed systems for first-year undergraduates through free online materials.**

Students learn by building applications they care about, progressing through modules at their own pace with Claude AI as their personal tutor.

---

## Core Philosophy

Students learn distributed systems by **building applications they care about**, not by studying abstractions. The curriculum is **self-paced** - students progress through modules at their own speed. Claude AI acts as a teaching assistant that:
...
## How Claude AI Enhances Learning
...
### **2. Claude Suggests Pipeline Structure**
```python
g = network([
...
### **3. Claude Generates Class Templates**
```python
...
5. Use Claude AI to accelerate development
