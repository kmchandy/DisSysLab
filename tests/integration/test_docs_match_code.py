...
MODULES_WITHOUT_DOCS: dict[str, str] = {
    ...
    "skill_versions.py": (
        "generated by scripts/stamp_skills.py and nothing but one dict; "
        "why the package records the skill version at all is in the "
        "generated docstring, and the check that reads it lives in "
        "skills_installed.stale_message"
    ),
