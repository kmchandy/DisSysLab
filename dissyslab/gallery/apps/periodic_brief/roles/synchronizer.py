"""Synchronizer for the periodic_brief news mini-pipeline.

Waits for one annotation on each of three named inports — entity_extractor,
topic_tagger, urgency_classifier — dict-merges them, and emits the
merged article on `out`.
"""
