...
class TestCartPoleSource:
    ...
    def test_agent_learns_over_time(self):
        ...
        cart = CartPoleSource(total_episodes=1000, checkpoint_every=50, seed=42)
        checkpoints = list(cart.run())
