...
hacker_articles = MockRSSSource(feed_name="hacker_news", max_articles=100)
tech_articles = MockRSSSource(feed_name="tech_news", max_articles=100)
reddit_articles = MockRSSSource(feed_name="reddit_python", max_articles=100)
