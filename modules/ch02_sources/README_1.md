...
The next set of examples illustrates sources. In these examples, a source agent is connected to a sink agent which displays the data acquired by the source. Later, we will study examples in which sources are connected to AI agents or Python data science functions that analyze data streams from sources. 
