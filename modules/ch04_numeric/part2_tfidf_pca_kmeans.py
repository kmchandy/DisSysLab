...
# ----------------------------------------------------------------------
#                       Since per-item logger
# ----------------------------------------------------------------------


def print_vec(msg):
    # Show a tiny signature: number of nonzero features, and current cluster
...
# _scatter_pca(results, pca, "TF-IDF + PCA + KMeans (all 10)", "part2_all10.svg")
