...
# Each office referenced must already have an app.py generated by make_office.py.
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python3 make_network.py gallery/org_name/")
        sys.exit(1)
